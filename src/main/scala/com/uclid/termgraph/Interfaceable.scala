...
private def typeUseToSortRef(
  ...
  t match {
    ...
    case _ =>
      throw new InternalNotSupportedYet(t)
  }
...
private def exprToTerm(
  ...
  expr match {
    ...
    case OperatorApplication(GetNextValueOp(), _) => {
      throw new InternalNotSupportedYet(expr)
    }
    ...
    case _ => throw new InternalNotSupportedYet(expr)
  ...
  (
    {
      ...
      lhs match {
        ...
        case e =>
          throw new InternalNotSupportedYet(e)
      }
    },
    newParams
  )
